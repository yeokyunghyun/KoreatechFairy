...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText register_name, register_email_id, register_pw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String registerId = register_email_id.getText().toString();
                ...
                //Firebase Auth 진행
                mFirebaseAuth.createUserWithEmailAndPassword(registerId, registerPw)
                        .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()) {
                                    FirebaseUser firebaseUser = mFirebaseAuth.getCurrentUser();
                                    User user = new User(firebaseUser.getUid(), firebaseUser.getEmail(), registerPw, selectedMajor, selectedStudentId);
